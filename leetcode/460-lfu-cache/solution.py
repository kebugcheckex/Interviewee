# Copied from https://leetcode.com/problems/lfu-cache/solutions/207673/python-concise-solution-detailed-explanation-two-dict-doubly-linked-list/
    ...
    def put(self, key, value):
        ...
        if key in self._node:
            ...
            if self._size == self._capacity:
                ...
                self._size -= 1
                print(f"[put] deleting key {node.key}")
